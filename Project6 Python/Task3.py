# TASK 3
# Next, I was taked to retrieve specific pieces of data from the table. I use a for loop to print the first column, which contains the names of the consoles.
